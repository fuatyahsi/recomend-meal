...
import 'package:fridge_chef/services/smart_actueller_feed_service.dart';
...
void main() {
  group('SmartActuellerFeedService', () {
    test('parses brochure feed into catalog items and brochure reports', () {
        ...
        "brochures": [
          {
            ...
            "title": "Bim 18 Mart 2026 Aktüel Kataloğu",
            "marketName": "BIM",
            "imageUrls": [
        ...
        "items": [
          {
            ...
            "brochureId": "55944",
            "marketName": "BIM",
            "productName": "Lav Kilitli Saklama Kabı",
            "discountPrice": 79.0,
            "confidence": 0.96,
      ...
      expect(snapshot.catalogItems.first.productTitle, 'Lav Kilitli Saklama Kabı');
