...
import 'package:fridge_chef/services/market_fiyati_source_service.dart';
import 'package:fridge_chef/utils/market_registry.dart';
...
void main() {
  group('MarketFiyatiSourceService', () {
        ...
        'content': [
          {
            ...
            'menu_category': 'Temizlik ve Kişisel Bakım Ürünleri',
            'productDepotInfoList': [
              {
                'depotId': 'bim-C741',
                'depotName': 'BIM Sube',
    ...
    test('builds session from nearest depots', () {
      ...
      expect(session.locationLabel, 'Aşağı Öveçler');
    ...
    test('builds session from location suggestion', () {
      ...
      const suggestion = MarketFiyatiLocationSuggestion(
        fullLabel: 'Aşağı Öveçler Mh. Öveçler 1 Alt Geçidi Çankaya Ankara',
        resultType: 'Y',
        pointOfInterestName: '',
        roadName: 'Öveçler 1 Alt Geçidi',
        neighborhood: 'Aşağı Öveçler Mh.',
        district: 'Çankaya',
        city: 'Ankara',
        longitude: 32.82538811194,
        latitude: 39.885826135396,
      ...
      const depots = [
        MarketFiyatiNearestDepot(
          id: 'bim-C726',
          sellerName: 'Aşağı Öveçler Çankaya',
          marketName: 'bim',
          latitude: 39.883568,
          longitude: 32.82376,
          distanceMeters: 286.84,
        ...
        MarketFiyatiNearestDepot(
          id: 'carrefour-5107',
          sellerName: 'Ankara Öveçler Mini',
      ...
      expect(
        ...
        'Öveçler 1 Alt Geçidi, Aşağı Öveçler Mh., Çankaya, Ankara',
      );
