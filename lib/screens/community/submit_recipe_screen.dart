...
class _SubmitRecipeScreenState extends State<SubmitRecipeScreen> {
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    if (picked != null) {
      setState(() {
        ...
        _uploadedImageUrl = null; // Reset if new image selected
      });
    }
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      // Fotoğraf seçildiyse ve henüz yüklenmediyse yükle
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(isTr
                ? 'Tarif paylaşılamadı: $e'
                : 'Failed to share recipe: $e'),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Fotoğraf Yükleme
              Text(isTr ? 'Tarif Fotoğrafı (İsteğe Bağlı)' : 'Recipe Photo (Optional)',
                  style: theme.textTheme.titleSmall),
              const SizedBox(height: 8),
              Container(
                width: double.infinity,
                ...
                child: _selectedImage == null
                    ...
                    : Stack(
                        children: [
                          ...
                          // Fotoğrafı değiştir/kaldır butonları
                          Positioned(
                            bottom: 8,
                            right: 8,
                            child: Row(
