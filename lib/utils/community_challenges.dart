...
class CommunityChallenges {
  static const List<CommunityChallenge> all = [
    CommunityChallenge(
      ...
      descriptionTr:
          'Sadece 3 ana malzemeyle yaratıcı bir tarif paylaş. Basit ama akılda kalan tarifler kazanır.',
      descriptionEn:
    ...
    CommunityChallenge(
      ...
      titleTr: 'Kahvaltı Blitz',
      titleEn: 'Breakfast Blitz',
      subtitleTr: 'Sabahın MVP tabağı',
      ...
      descriptionEn:
          'Upload fast, energetic breakfast recipes worth sharing for the best start to the day.',
